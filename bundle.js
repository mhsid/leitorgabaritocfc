...
function templateStatus(){const ts=state.templates||{};$('templateStatus').textContent=[0,1].map(d=>`${d+1}º dia: ${ts[d]?'modelo de 90 questões cadastrado':'aguardando cartão completo'}`).join(' · ');}
